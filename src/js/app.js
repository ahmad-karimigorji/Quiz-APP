...
let questionsData = [
    ...
    {
        id: 1077,
        question: "You are logged in as a normal user and you see a file with 444(-r--r--r--) permission. Can you delete it with the `rm` command?",
        description: null,
        answers: {
            answer_a: "We can't be certain, it depends on the permissions of the parent folder",
...
function questionHtmlDOM() {
  ...
  <div class="quiz-choices">
    <div class="choice ${!currentQuestion.answers.answer_a ? "unChoice" : ""}" data-correctAnswer="answer_a_correct">
      <p class="choice-number">A</p>
      <p class="choice-text">${currentQuestion.answers.answer_a ? currentQuestion.answers.answer_a : ""}</p>
    </div>
    <div class="choice ${!currentQuestion.answers.answer_b ? "unChoice" : ""}" data-correctAnswer="answer_b_correct">
      <p class="choice-number">B</p>
      <p class="choice-text">${currentQuestion.answers.answer_b ? currentQuestion.answers.answer_b : ""}</p>
    </div>
    <div class="choice ${!currentQuestion.answers.answer_c ? "unChoice" : ""}" data-correctAnswer="answer_c_correct">
      <p class="choice-number">C</p>
      <p class="choice-text">${currentQuestion.answers.answer_c ? currentQuestion.answers.answer_c : ""}</p>
    </div>
    <div class="choice ${!currentQuestion.answers.answer_d ? "unChoice" : ""}" data-correctAnswer="answer_d_correct">
      <p class="choice-number">D</p>
      <p class="choice-text">${currentQuestion.answers.answer_d ? currentQuestion.answers.answer_d : ""}</p>
      </div>
      </div>`;
}
function renderQuestion() {
    ...
    choices.forEach((item) => item.addEventListener("click", () => choiceClicked(item)));
}
